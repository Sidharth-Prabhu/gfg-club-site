        ...
        <div className="flex-grow p-6 md:p-10 space-y-8">
          <div className="flex justify-between items-center">
            <div className="space-y-0.5">
                <h3 className="text-2xl font-black text-text uppercase tracking-tighter italic">Authorize <span className="text-accent">Access</span></h3>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input 
                    required 
                    type="email" 
                    className="w-full bg-background border-2 border-border rounded-xl py-3.5 pl-11 pr-4 focus:border-accent outline-none text-text text-sm font-bold transition shadow-inner italic" 
