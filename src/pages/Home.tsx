...
import { Code, Users, Award, TrendingUp, ArrowRight, Zap, BookOpen, Trophy, ChevronRight, Sparkles, Star, Target, Lightbulb, Calendar } from 'lucide-react';
  ...
  return (
    <div className="space-y-32 overflow-hidden">
      ...
      <section className="container mx-auto px-4">
        ...
        >
          <StatsCard title="Community Members" value={campusStats.totalMembers} icon={Users} color="bg-blue-500" />
      ...
      <section className="container mx-auto px-4 space-y-12">
        <div className="flex flex-col md:flex-row justify-between items-end gap-6">
          ...
          <Link to="/events" className="group bg-accent/10 hover:bg-accent text-accent hover:text-white px-8 py-4 rounded-2xl font-bold transition-all flex items-center gap-2 uppercase text-sm tracking-widest shadow-sm">
            View All Events <ChevronRight size={20} className="group-hover:translate-x-1 transition-transform" />
          </Link>
        </div>
      ...
      <section className="container mx-auto px-4 py-10">
        <div className="bg-accent rounded-[4rem] p-12 md:p-24 relative overflow-hidden shadow-2xl shadow-accent/20">
          <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23ffffff' fill-opacity='1' fill-rule='evenodd'%3E%3Ccircle cx='3' cy='3' r='3'/%3E%3Ccircle cx='13' cy='13' r='3'/%3E%3C/g%3E%3C/svg%3E")` }}></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
                {[
                  { icon: Star, text: 'GfG Official Certification' },
                  { icon: Target, text: 'Industry Expert Mentorship' },
                  { icon: Lightbulb, text: 'Hands-on Project Work' },
                  { icon: Users, text: 'Vibrant Coding Community' }
                ].map((item, i) => (
