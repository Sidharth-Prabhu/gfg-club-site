    ...
    <div className="container mx-auto px-4 py-8 space-y-32 overflow-hidden">
          ...
          >
            <div className="w-full aspect-square md:aspect-video lg:aspect-square rounded-[3.5rem] bg-accent/5 border border-accent/10 p-8 flex items-center justify-center relative overflow-visible">
              ...
              <div className="relative z-10 w-full max-w-sm">
                ...
                {/* Decorative Elements */}
                <div className="absolute -top-10 -right-6 bg-accent text-white px-4 py-2 rounded-lg font-black text-[10px] uppercase tracking-widest shadow-xl -rotate-12 group-hover:rotate-0 transition-transform">Official Chapter</div>
      ...
      <section className="container mx-auto px-4 py-10">
        <div className="text-center space-y-4 mb-20">
          <h2 className="text-accent font-black uppercase tracking-[0.3em] text-sm">Leadership Team</h2>
