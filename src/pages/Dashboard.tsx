    ...
    <div className="space-y-8 max-w-7xl mx-auto px-4 md:px-0 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          ...
          <p className="text-gray-500 mt-1 font-bold text-sm tracking-[0.2em] uppercase">Club Management & Analytics</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-card border border-gray-800 p-8 rounded-[2.5rem] shadow-sm">
                <div className="flex justify-between items-center mb-8">
                    <h2 className="text-2xl font-black text-white uppercase tracking-tighter">My Submissions</h2>
                    <span className="bg-background border border-gray-800 px-4 py-1.5 rounded-full text-[10px] font-black text-gray-500 uppercase tracking-[0.2em]">{myProjects.length} Records</span>
                </div>
                {myProjects.length > 0 ? (
        ...
        <div className="space-y-8">
            <div className="bg-card border border-gray-800 p-8 rounded-[2.5rem] space-y-10 shadow-lg">
                <h2 className="text-2xl font-black text-white uppercase tracking-tighter">Coding Node</h2>
                <div className="space-y-5">
                    ...
                    <div key={i} className="p-5 bg-background border border-gray-800 rounded-[1.5rem] shadow-inner hover:border-accent/30 transition-colors">
              ...
              <div className="p-10 md:p-16 space-y-10">
                    ...
                    <div className="flex flex-col lg:flex-row gap-16">
                        <div className="flex-grow space-y-12">
                            ...
                            <div className="space-y-6">
                                <h4 className="text-2xl font-black text-white flex items-center gap-3"><Code2 size={24} className="text-accent" /> Tech Stack</h4>
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/95 backdrop-blur-md overflow-y-auto">
            <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 50 }} className="bg-card border border-gray-800 rounded-[2.5rem] w-full max-w-4xl my-auto shadow-2xl overflow-hidden">
              <div className="p-8 border-b border-gray-800 flex justify-between items-center bg-background/50">
                <h2 className="text-3xl font-black text-white uppercase tracking-tighter">Edit Project Submission</h2>
              ...
              <form onSubmit={handleUpdateProfile} className="p-10 space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                        <label className="block text-[10px] font-black text-gray-600 uppercase tracking-[0.3em] ml-1">Full Name</label>
                    ...
                    <div className="space-y-2">
                        <label className="block text-[10px] font-black text-gray-600 uppercase tracking-[0.3em] ml-1">Department</label>
                ...
                <div className="space-y-6 pt-4 border-t border-gray-800">
                  ...
                  <div className="space-y-4">
                    <div>
                        <label className="block text-[10px] font-black text-gray-600 uppercase mb-1 ml-1">GfG Profile</label>
                    ...
                    <div>
                        <label className="block text-[10px] font-black text-gray-600 uppercase mb-1 ml-1">GitHub Profile</label>
                        <input type="url" placeholder="https://github.com/username" className="w-full bg-background border-2 border-gray-800 rounded-2xl py-4 px-6 focus:border-accent outline-none text-white font-medium transition shadow-inner" value={editFormData.github_profile} onChange={(e) => setEditFormData({...editFormData, github_profile: e.target.value})} />
                    </div>
                    <div>
                        <label className="block text-[10px] font-black text-gray-600 uppercase mb-1 ml-1">LeetCode Profile</label>
      ...
      <style>{`
        ...
        .ql-editor { min-height: 200px; color: #f1f5f9; padding: 30px !important; line-height: 1.8; }
